...
PresetColors (Go) or preset-colors (Clojure). The keys are the names of preset colors in lower-case and the 
...
function parseHTMLColor(color) {
  if (color.startsWith("#")) {
    ...
    if (PRESET_COLORS.hasOwnProperty(lowerCaseColor)) {
      return parseHTMLColor(PRESET_COLORS[lowerCaseColor]);
    }
  }
